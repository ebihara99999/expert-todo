...
Rails.application.config.sorcery.submodules = [:jwt_auth]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # Default: nil
    #
    # config.jwt_secret_key = '06795dfead4d87788daae1401a818637d083abd5280b017dc2c2117fc00af25be9d3bab25a3a6076996aaecc24bd0e4dbfbf327c7cff2ec0951f1362814ecc6f'
  end
